    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-3 col-lg-2 filled proclamateurs">
            <div class="card text-center">
                <a href="<?= site_url('rp') ?>">
                    <img class="card-img-top" src="<?= base_url() . 'assets/img/rp.png' ?>" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Responsables prédication</h5>
                    </div>
                </a>
            </div>
        </div>
        ...
        <div class="col-sm-12 col-md-3 col-lg-2 text-center filled planning">
            <div class="card">
                <a href="<?= site_url('creneaux') ?>">
                    <img class="card-img-top" src="<?= base_url() . 'assets/img/repartition2.png' ?>" alt="Card image cap">
                    <div class="card-body">
                        <h5 class="card-title">Affectation lieux</h5>
                    </div>
                </a>
            </div>
        </div>
