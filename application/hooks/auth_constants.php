...
*/
	...
	define('LOGIN_PAGE', 'connexion');

/*
| -----------------------------------------------------------------
| Authentication Logout Parameter
| -----------------------------------------------------------------
| This is the query string parameter ($_GET param) that Community Auth 
| uses to indicate that a logout message should be shown to the user 
| when they are logging out. Added in v3.2.2, this was made customizable 
| in case the parameter would conflict with an existing application. 
| 
*/
